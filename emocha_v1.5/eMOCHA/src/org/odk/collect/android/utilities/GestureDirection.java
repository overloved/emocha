...
public class GestureDirection {
    ...
    /**
     * Class constructor.
     * @param x X coordinate of current motion.
     * @param y Y coordinate of current motion.
     */
    ...
    /**
     * Store the end position of single gesture motion.
     * @param x X coordinate of the end of the current gesture motion.
     * @param y Y coordinate of the end of the current gesture motion.
     */
    ...
    /**
     * Calculate the direction of the current gesture.
     * @return The direction of the gesture motion.
     */
